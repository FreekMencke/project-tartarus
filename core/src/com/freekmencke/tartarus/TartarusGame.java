package com.freekmencke.tartarus;
...
import com.freekmencke.tartarus.system.input.SystemInputAdapter;
import io.reactivex.rxjava3.subjects.BehaviorSubject;

import java.text.MessageFormat;

public class TartarusGame extends Game {
    ...
    public static TartarusGame getInstance() {
        return (TartarusGame) Gdx.app.getApplicationListener();
    }
    ...
    public void create() {
        ...
        TartarusGame.addInputProcessor(new SystemInputAdapter());
